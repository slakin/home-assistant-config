...
from homeassistant.const import (STATE_OFF, STATE_ON, CONF_HOST, CONF_NAME, STATE_PLAYING, STATE_PAUSED, STATE_IDLE)
...
class OnkyoDevice(MediaPlayerDevice):
    ...
    def update(self):
        ...
        play_status_raw = self.command('dock.net-usb-play-status query')
        ...
        self._is_playback_supported = True
        self._play_status = play_status_raw[1][1]
    ...
    def supported_features(self):
        ...
        return SUPPORT_ONKYO | SUPPORT_MEDIA_MODES
    ...
    def media_play(self):
        """Send play commmand."""
        self.send('dock.network-usb play')
    
    def media_pause(self):
        """Send pause command."""
        self.send('dock.network-usb pause')

    def media_stop(self):
        """Send stop command."""
        self.send('dock.network-usb stop')

    def media_previous_track(self):
        """Send previous track command."""
        self.send('dock.network-usb trdn')

    def media_next_track(self):
        """Send next track command."""
        self.send('dock.network-usb trup')
    
    @property
    def media_artist(self):
        """Artist of current playing media."""
        if self._play_status is not None:
            return self.command('dock.net-usb-artist-name-info query')[1]

    @property
    def media_album_name(self):
        """Album of current playing media."""
        if self._play_status is not None:
            return self.command('dock.net-usb-album-name-info query')[1]
    ...
    def media_title(self):
        """Artist of current playing media."""
        if self._play_status is not None:
            return self.command('dock.net-usb-title-name query')[1]